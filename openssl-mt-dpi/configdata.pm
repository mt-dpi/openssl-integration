...
our %config = (
  ...
  build_type => "release",
  builddir => ".",
  cflags => [ "-DDEBUG_LEVEL=2", "-Wa,--noexecstack" ],
            ...
            "../src/etc" =>
                {
                    "deps" =>
                        [
                            "../src/etc/association_table.o",
                            "../src/etc/base64.o",
                            "../src/etc/bit_op.o",
                            "../src/etc/broker.o",
                            "../src/etc/circuit.o",
                            "../src/etc/circuit_randomization.o",
                            "../src/etc/counter_table.o",
                            "../src/etc/fernet.o",
                            "../src/etc/garbled_circuit.o",
                            "../src/etc/gc_protocol.o",
                            "../src/etc/handle_table.o",
                            "../src/etc/message.o",
                            "../src/etc/oblivious_transfer.o",
                            "../src/etc/search_tree.o",
                            "../src/etc/security_context.o",
                            "../src/etc/table.o",
                            "../src/etc/token.o",
                        ],
                    "products" =>
            ...
            "../src/rule_preparer" =>
                {
                    "deps" =>
                        [
                            "../src/rule_preparer/circuit_randomization.o",
                            "../src/rule_preparer/fixedkey_cluster.o",
                            "../src/rule_preparer/fixedkey_global.o",
                            "../src/rule_preparer/fixedkey_perkeyword.o",
                            "../src/rule_preparer/garbled_circuit.o",
                            "../src/rule_preparer/nonfixedkey_cluster.o",
                            "../src/rule_preparer/nonfixedkey_global.o",
                            "../src/rule_preparer/nonfixedkey_perkeyword.o",
                            "../src/rule_preparer/rule_preparer.o",
                            "../src/rule_preparer/test.o",
                        ],
                    "products" =>
                        {
                            "lib" =>
            ...
            "../src/token_detector" =>
                {
                    "deps" =>
                        [
                            "../src/token_detector/fixedkey_cluster.o",
                            "../src/token_detector/fixedkey_global.o",
                            "../src/token_detector/fixedkey_perkeyword.o",
                            "../src/token_detector/nonfixedkey_cluster.o",
                            "../src/token_detector/nonfixedkey_global.o",
                            "../src/token_detector/nonfixedkey_perkeyword.o",
                            "../src/token_detector/test.o",
                            "../src/token_detector/token_detector.o",
                        ],
                    "products" =>
                        {
                            "lib" =>
            ...
            "../src/token_encryptor" =>
                {
                    "deps" =>
                        [
                            "../src/token_encryptor/fixedkey_cluster.o",
                            "../src/token_encryptor/fixedkey_global.o",
                            "../src/token_encryptor/fixedkey_perkeyword.o",
                            "../src/token_encryptor/nonfixedkey_cluster.o",
                            "../src/token_encryptor/nonfixedkey_global.o",
                            "../src/token_encryptor/nonfixedkey_perkeyword.o",
                            "../src/token_encryptor/test.o",
                            "../src/token_encryptor/token_encryptor.o",
                        ],
                    "products" =>
                        {
                            "lib" =>
            ...
            "../src/tokenizer" =>
                {
                    "deps" =>
                        [
                            "../src/tokenizer/test.o",
                            "../src/tokenizer/tokenizer.o",
                            "../src/tokenizer/window_based.o",
                        ],
                    "products" =>
                        {
                            "lib" =>
            ...
            "../src/tree_updater" =>
                {
                    "deps" =>
                        [
                            "../src/tree_updater/fixedkey_cluster.o",
                            "../src/tree_updater/fixedkey_global.o",
                            "../src/tree_updater/fixedkey_perkeyword.o",
                            "../src/tree_updater/nonfixedkey_cluster.o",
                            "../src/tree_updater/nonfixedkey_global.o",
                            "../src/tree_updater/nonfixedkey_perkeyword.o",
                            "../src/tree_updater/test.o",
                            "../src/tree_updater/tree_updater.o",
                        ],
                    "products" =>
                        {
                            "lib" =>
    ...
    "sources" =>
        {
            ...
            "../src/etc/circuit_randomization.o" =>
                [
                    "../src/etc/circuit_randomization.c",
                ],
            "../src/etc/counter_table.o" =>
                [
                    "../src/etc/counter_table.c",
                ],
            "../src/etc/fernet.o" =>
                [
                    "../src/etc/fernet.c",
            ...
            "../src/etc/garbled_circuit.o" =>
                [
                    "../src/etc/garbled_circuit.c",
                ],
            "../src/etc/gc_protocol.o" =>
                [
                    "../src/etc/gc_protocol.c",
                ],
            "../src/etc/handle_table.o" =>
                [
                    "../src/etc/handle_table.c",
                ],
            "../src/etc/message.o" =>
                [
                    "../src/etc/message.c",
            ...
            "../src/etc/oblivious_transfer.o" =>
                [
                    "../src/etc/oblivious_transfer.c",
                ],
            "../src/etc/search_tree.o" =>
                [
                    "../src/etc/search_tree.c",
                ],
            "../src/etc/security_context.o" =>
                [
                    "../src/etc/security_context.c",
                ],
            "../src/etc/table.o" =>
                [
                    "../src/etc/table.c",
            ...
            "../src/rule_preparer/circuit_randomization.o" =>
                [
                    "../src/rule_preparer/circuit_randomization.c",
                ],
            "../src/rule_preparer/fixedkey_cluster.o" =>
                [
                    "../src/rule_preparer/fixedkey_cluster.c",
                ],
            "../src/rule_preparer/fixedkey_global.o" =>
                [
                    "../src/rule_preparer/fixedkey_global.c",
                ],
            "../src/rule_preparer/fixedkey_perkeyword.o" =>
                [
                    "../src/rule_preparer/fixedkey_perkeyword.c",
                ],
            "../src/rule_preparer/garbled_circuit.o" =>
                [
                    "../src/rule_preparer/garbled_circuit.c",
                ],
            "../src/rule_preparer/nonfixedkey_cluster.o" =>
                [
                    "../src/rule_preparer/nonfixedkey_cluster.c",
                ],
            "../src/rule_preparer/nonfixedkey_global.o" =>
                [
                    "../src/rule_preparer/nonfixedkey_global.c",
                ],
            "../src/rule_preparer/nonfixedkey_perkeyword.o" =>
                [
                    "../src/rule_preparer/nonfixedkey_perkeyword.c",
                ],
            "../src/rule_preparer/rule_preparer.o" =>
                [
                    "../src/rule_preparer/rule_preparer.c",
                ],
            "../src/rule_preparer/test.o" =>
                [
                    "../src/rule_preparer/test.c",
                ],
            "../src/token_detector/fixedkey_cluster.o" =>
                [
                    "../src/token_detector/fixedkey_cluster.c",
                ],
            "../src/token_detector/fixedkey_global.o" =>
                [
                    "../src/token_detector/fixedkey_global.c",
                ],
            "../src/token_detector/fixedkey_perkeyword.o" =>
                [
                    "../src/token_detector/fixedkey_perkeyword.c",
                ],
            "../src/token_detector/nonfixedkey_cluster.o" =>
                [
                    "../src/token_detector/nonfixedkey_cluster.c",
                ],
            "../src/token_detector/nonfixedkey_global.o" =>
                [
                    "../src/token_detector/nonfixedkey_global.c",
                ],
            "../src/token_detector/nonfixedkey_perkeyword.o" =>
                [
                    "../src/token_detector/nonfixedkey_perkeyword.c",
                ],
            "../src/token_detector/test.o" =>
                [
                    "../src/token_detector/test.c",
                ],
            "../src/token_detector/token_detector.o" =>
                [
                    "../src/token_detector/token_detector.c",
                ],
            "../src/token_encryptor/fixedkey_cluster.o" =>
                [
                    "../src/token_encryptor/fixedkey_cluster.c",
                ],
            "../src/token_encryptor/fixedkey_global.o" =>
                [
                    "../src/token_encryptor/fixedkey_global.c",
                ],
            "../src/token_encryptor/fixedkey_perkeyword.o" =>
                [
                    "../src/token_encryptor/fixedkey_perkeyword.c",
                ],
            "../src/token_encryptor/nonfixedkey_cluster.o" =>
                [
                    "../src/token_encryptor/nonfixedkey_cluster.c",
                ],
            "../src/token_encryptor/nonfixedkey_global.o" =>
                [
                    "../src/token_encryptor/nonfixedkey_global.c",
                ],
            "../src/token_encryptor/nonfixedkey_perkeyword.o" =>
                [
                    "../src/token_encryptor/nonfixedkey_perkeyword.c",
                ],
            "../src/token_encryptor/test.o" =>
                [
                    "../src/token_encryptor/test.c",
                ],
            "../src/token_encryptor/token_encryptor.o" =>
                [
                    "../src/token_encryptor/token_encryptor.c",
                ],
            "../src/tokenizer/test.o" =>
                [
                    "../src/tokenizer/test.c",
                ],
            "../src/tokenizer/tokenizer.o" =>
                [
            ...
            "../src/tokenizer/window_based.o" =>
                [
                    "../src/tokenizer/window_based.c",
                ],
            "../src/tree_updater/fixedkey_cluster.o" =>
                [
                    "../src/tree_updater/fixedkey_cluster.c",
                ],
            "../src/tree_updater/fixedkey_global.o" =>
                [
                    "../src/tree_updater/fixedkey_global.c",
                ],
            "../src/tree_updater/fixedkey_perkeyword.o" =>
                [
                    "../src/tree_updater/fixedkey_perkeyword.c",
                ],
            "../src/tree_updater/nonfixedkey_cluster.o" =>
                [
                    "../src/tree_updater/nonfixedkey_cluster.c",
                ],
            "../src/tree_updater/nonfixedkey_global.o" =>
                [
                    "../src/tree_updater/nonfixedkey_global.c",
                ],
            "../src/tree_updater/nonfixedkey_perkeyword.o" =>
                [
                    "../src/tree_updater/nonfixedkey_perkeyword.c",
                ],
            "../src/tree_updater/test.o" =>
                [
                    "../src/tree_updater/test.c",
                ],
            "../src/tree_updater/tree_updater.o" =>
                [
                    "../src/tree_updater/tree_updater.c",
                ],
            "../src/util/conf.o" =>
                [
                    "../src/util/conf.c",
