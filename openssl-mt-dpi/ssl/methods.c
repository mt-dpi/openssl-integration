...
IMPLEMENT_tls_meth_func(TLS1_3_VERSION, 0, SSL_OP_NO_TLSv1_3,
                        tls_mtdpi_method,
                        ossl_statem_accept,
                        ossl_statem_connect, TLS_mtdpi_enc_data)
///// Added for MT-DPI /////
...
///// Added for MT-DPI /////
IMPLEMENT_tls_meth_func(TLS1_3_VERSION, 0, SSL_OP_NO_TLSv1_3,
                        tls_mtdpi_server_method,
                        ossl_statem_accept,
                        ssl_undefined_function, TLS_mtdpi_enc_data)
////////////////////////////
#ifndef OPENSSL_NO_TLS1_2_METHOD
IMPLEMENT_tls_meth_func(TLS1_2_VERSION, 0, SSL_OP_NO_TLSv1_2,
...
///// Added for MT-DPI /////
const SSL_METHOD *TLS_mtdpi_method(void)
{
    return tls_mtdpi_method();
}

const SSL_METHOD *TLS_mtdpi_server_method(void)
{
    return tls_mtdpi_server_method();
}

const SSL_METHOD *TLS_mtdpi_client_method(void)
{
    return tls_mtdpi_client_method();
}
////////////////////////////
