...
SSL *SSL_new(SSL_CTX *ctx)
{
    ...
    ///// Added for MT-DPI /////
    s->mt_dpi.middlebox = ctx->mt_dpi.middlebox;
    s->mt_dpi.to_middlebox = ctx->mt_dpi.to_middlebox;
    s->mt_dpi.dpi = ctx->mt_dpi.dpi;
    if (!ctx->mt_dpi.conf)
      s->mt_dpi.conf = init_conf_module();
    else
      s->mt_dpi.conf = ctx->mt_dpi.conf;
    s->mt_dpi.nrules = ctx->mt_dpi.nrules;
    s->mt_dpi.certs = ctx->mt_dpi.certs;
    s->mt_dpi.rgkey = ctx->mt_dpi.rgkey;
    s->mt_dpi.rgklen = ctx->mt_dpi.rgklen;
    s->mt_dpi.rgrand = ctx->mt_dpi.rgrand;
    s->mt_dpi.rgrlen = ctx->mt_dpi.rgrlen;
    s->mt_dpi.handles = ctx->mt_dpi.handles;
    ////////////////////////////
...
void SSL_free(SSL *s)
{
    ...
    ///// Added for MT-DPI /////
    if (s->mt_dpi.dpi)
      free_dpi_context(s->mt_dpi.dpi);
    s->mt_dpi.dpi = NULL;

    if (s->mt_dpi.conf)
      free_conf_module(s->mt_dpi.conf);
    s->mt_dpi.conf = NULL;
    ////////////////////////////
...
# endif
    ...
    ///// Added for MT-DPI /////
    ret->mt_dpi.middlebox = 0;
    ret->mt_dpi.dpi = NULL;
    ret->mt_dpi.conf = NULL;
    ret->mt_dpi.handles = NULL;
    ////////////////////////////
...
void SSL_CTX_free(SSL_CTX *a)
{
    ...
    ///// Added for MT_DPI /////
    if (a->mt_dpi.dpi)
      free_dpi_context(a->mt_dpi.dpi);
    a->mt_dpi.dpi = NULL;

    if (a->mt_dpi.conf)
      free_conf_module(a->mt_dpi.conf);
    a->mt_dpi.conf = NULL;
    ////////////////////////////
...
///// Added for MT-DPI /////
void SSL_CTX_mt_dpi_set_handle_table(SSL_CTX *ctx, handle_table_t *handles)
{
  ctx->mt_dpi.handles = handles;
}

handle_table_t *SSL_mt_dpi_get_handle_table(SSL *s)
{
  return s->mt_dpi.handles;
}

void SSL_CTX_mt_dpi_set_middlebox(SSL_CTX *ctx)
{
  ctx->mt_dpi.middlebox = 1;
}

void SSL_mt_dpi_set_middlebox(SSL *s)
{
  s->mt_dpi.middlebox = 1;
}

int SSL_CTX_mt_dpi_is_middlebox(SSL_CTX *ctx)
{
  return ctx->mt_dpi.middlebox;
}

int SSL_mt_dpi_is_middlebox(SSL *s)
{
  return s->mt_dpi.middlebox;
}

void SSL_CTX_mt_dpi_set_to_middlebox(SSL_CTX *ctx)
{
  ctx->mt_dpi.to_middlebox = 1;
}

void SSL_mt_dpi_set_to_middlebox(SSL *s)
{
  s->mt_dpi.to_middlebox = 1;
}

int SSL_CTX_mt_dpi_is_to_middlebox(SSL_CTX *ctx)
{
  return ctx->mt_dpi.to_middlebox;
}

void SSL_CTX_mt_dpi_set_cr_public_parameters(SSL_CTX *ctx, uint8_t *rgkey, int rgklen,
    uint8_t **certs, int nrules)
{
  ctx->mt_dpi.certs = certs;
  ctx->mt_dpi.nrules = nrules;
  ctx->mt_dpi.rgkey = rgkey;
  ctx->mt_dpi.rgklen = rgklen;
}

void SSL_CTX_mt_dpi_set_cr_rg_random_value(SSL_CTX *ctx, uint8_t *rgrand, int rgrlen)
{
  ctx->mt_dpi.rgrand = rgrand;
  ctx->mt_dpi.rgrlen = rgrlen;
}


int SSL_mt_dpi_is_to_middlebox(SSL *s)
{
  return s->mt_dpi.to_middlebox;
}

unsigned char *SSL_mt_dpi_get_association_key(SSL *s, int *klen)
{
  *klen = s->mt_dpi.klen;
  return s->mt_dpi.key;
}

void SSL_mt_dpi_set_server(SSL *s)
{
  s->mt_dpi.server = 1;
}

int SSL_mt_dpi_is_server(SSL *s)
{
  return s->mt_dpi.server;
}

void SSL_mt_dpi_set_master_ssl(SSL *a, SSL *b)
{
  a->mt_dpi.master = b;
}

void SSL_mt_dpi_set_association_table(SSL *s, void *table)
{
  s->mt_dpi.table = (association_table_t *) table;
}

unsigned char *SSL_mt_dpi_get_auth_value(SSL *s, int *alen)
{
  *alen = s->mt_dpi.alen;
  return s->mt_dpi.auth;
}

void SSL_mt_dpi_set_complete(SSL *s)
{
  s->mt_dpi.complete = 1;
}

int SSL_mt_dpi_is_completed(SSL *s)
{
  return s->mt_dpi.complete;
}

void SSL_mt_dpi_enable_init(SSL *s)
{
  s->mt_dpi.init = 1;
}

void SSL_mt_dpi_disable_init(SSL *s)
{
  s->mt_dpi.init = 0;
}

uint8_t **SSL_mt_dpi_get_certificates(SSL *s, int *nrules)
{
  *nrules = s->mt_dpi.nrules;
  return s->mt_dpi.certs;
}

void SSL_enable_mt_dpi(SSL *s)
{
  s->mt_dpi.enabled = 1;
  s->mt_dpi.mode = 0; // MT-DPI
}

void SSL_disable_mt_dpi(SSL *s)
{
  s->mt_dpi.enabled = 0;
  s->mt_dpi.mode = 0; // MT-DPI
}

void SSL_enable_blindbox(SSL *s)
{
  s->mt_dpi.enabled = 1;
  s->mt_dpi.mode = 1; // BlindBox
}

void SSL_disable_blindbox(SSL *s)
{
  s->mt_dpi.enabled = 0;
  s->mt_dpi.mode = 1; // BlindBox
}
