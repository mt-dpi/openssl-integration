...
///// Added for MT-DPI /////
static int init_mt_dpi(SSL *s, unsigned int context);
static int final_mt_dpi(SSL *s, unsigned int context, int sent);
////////////////////////////
...
static const EXTENSION_DEFINITION ext_defs[] = {
    ...
    },
    {
        ...
        init_mt_dpi,
        tls_parse_ctos_mt_dpi, tls_parse_stoc_mt_dpi,
        tls_construct_stoc_mt_dpi, tls_construct_ctos_mt_dpi,
        final_mt_dpi
    },
    {
