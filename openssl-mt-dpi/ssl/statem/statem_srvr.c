...
static WRITE_TRAN ossl_statem_server13_write_transition(SSL *s)
{
    ...
    case TLS_ST_SR_FINISHED:
        ...
        ///// Added for MT-DPI /////
        if (s->ext.use_mt_dpi && !s->mt_dpi.middlebox && !s->mt_dpi.to_middlebox)
        {
          dmsg(DPI_DEBUG_LIBRARY, "Waiting for the channel establishment with MB");
          while (!s->mt_dpi.complete) {}
          dmsg(DPI_DEBUG_LIBRARY, "The channel is established with MB");
        }
        ////////////////////////////
