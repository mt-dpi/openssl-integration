...
///// Added for MT-DPI /////
__owur const SSL_METHOD *TLS_mtdpi_method(void);
__owur const SSL_METHOD *TLS_mtdpi_server_method(void);
__owur const SSL_METHOD *TLS_mtdpi_client_method(void);
////////////////////////////
...
#define MT_DPI_TLS_SERVER 1
#define MT_DPI_TLS_CLIENT 0

#define MT_DPI_TYPE_INIT  0
#define MT_DPI_TYPE_TOKEN 1

#define MT_DPI_MB_HOSTNAME  "www.mt-mb.com"
#define MT_DPI_DEFAULT_PORT 5555
