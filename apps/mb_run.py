...
def command_line_args():
    ...
    parser.add_argument("-v", "--tuidx", metavar="<tree update index file>", help="tree update index", type=str, default="../src/tree_updater/tree_updater.h")
    parser.add_argument("-w", "--rpidx", metavar="<rule preparation index file>", help="rule preparation index", type=str, default="../src/rule_preparer/rule_preparer.h")
    parser.add_argument("-x", "--tnidx", metavar="<tokenization index file>", help="tokenization index", type=str, default="../src/tokenizer/tokenizer.h")
    parser.add_argument("-y", "--teidx", metavar="<token encryption index file>", help="token encryption index", type=str, default="../src/token_encryptor/token_encryptor.h")
    parser.add_argument("-z", "--tdidx", metavar="<token decryption index file>", help="token decryption index", type=str, default="../src/token_detector/token_detector.h")
...
def main():
    ...
    if "Forwarding port" in conf:
        cmd.append("-5")
        cmd.append(conf["Forwarding port"])

    if "Initialization" in conf:
