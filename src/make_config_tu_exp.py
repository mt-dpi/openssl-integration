...
def make_config(ofname, rname, lname, cnum, pnum):
    ...
    with open(ofname, "w") as of:
        ...
        of.write("# Input data\n")
        of.write("Input filename: ../data/inputs/input_tu.html\n\n")
        ...
        if num in [2, 3, 5, 6]:
            of.write("Num of trees: 108\n")
        else:
            of.write("Num of trees: 1\n")
        of.write("Maximum num of fetched: 1\n\n")

        of.write("# Logging\n")
        of.write("Logging: False\n")
        of.write("Log directory: {}\n".format(lname))
...
def main():
    ...
    make_config(ofname, rname, lname, cnum, pnum)
